 ...
 */
class EtepprepaidConfig
{
    const PAYMENT_METHOD_ETEPPREPAID_CODE = 'etep_prepaid';
    const PAYMENT_METHOD_ETEPPREPAID_XML_PATH = 'payment/etep_prepaid/cctypes';
     ...
     * @var string
     */
    protected $CODE = self::PAYMENT_METHOD_ETEPPREPAID_CODE;
    protected $_code = self::PAYMENT_METHOD_ETEPPREPAID_CODE;
