...
use CreditAgricole\Etransactions\Model\Ui\EtepprivateConfig;

/**
 * Class ConfigProvider
 */
final class EtepprivateConfigProvider implements ConfigProviderInterface
{
    const CODE = 'etep_private';
    ...
    public function getCards()
    {
        ...
        $etepprivateConfig = $object_manager->get('CreditAgricole\Etransactions\Model\Ui\EtepprivateConfig');
        ...
        $cards = [];
        $types = $etepprivateConfig->getCards();
        ...
        foreach ($types as $code) {
            $asset = $assetRepository->createAsset('CreditAgricole_Etransactions::images/' . strtoupper($code) . '.svg');
