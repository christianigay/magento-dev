 ...
 */
class EteppaybuttonsConfig
{
    const PAYMENT_METHOD_ETEPPAYBUTTONS_CODE = 'etep_paybuttons';
    const PAYMENT_METHOD_ETEPPAYBUTTONS_XML_PATH = 'payment/etep_paybuttons/cctypes';
     ...
     * @var string
     */
    protected $CODE = self::PAYMENT_METHOD_ETEPPAYBUTTONS_CODE;
    protected $_code = self::PAYMENT_METHOD_ETEPPAYBUTTONS_CODE;
    ...
    public function getCards()
    {
        ...
        return $this->scopeConfig->getValue(self::PAYMENT_METHOD_ETEPPAYBUTTONS_XML_PATH, $storeScope);
    }
}
